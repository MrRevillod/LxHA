        ...
        <table width="100%">
            <tr>
                <td>
                    ...
                    <p style="color: black;">¡Gracias por unirte a LXHA! Para validar tu cuenta, por favor haz clic en el siguiente enlace:</p>
                    <p><a href="${url}" style="color: #F5F5F5; background-color: #387EF2; padding: 8px 16px; text-decoration: none; border-radius: 4px;">Validar cuenta</a></p>
